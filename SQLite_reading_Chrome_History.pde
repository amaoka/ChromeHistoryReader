...
void setup()
{
    ...
    db = new SQLite( this, "/Users/YOUR_ACCOUNT_NAME/Library/Application Support/Google/Chrome/Profile 1/History" );  // open database file
     ///Users/amaoka/Library/Application Support/Google/Chrome/Profile 1/History
     // Sometimes directory should be "defalut" instead of "Profile 1"
     // Please make sure your environment.""""
if ( db.connect() )
    {
